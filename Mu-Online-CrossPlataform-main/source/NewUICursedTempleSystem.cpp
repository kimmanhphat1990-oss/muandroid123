...
//#endif //_DEBUG
	...
	{
		float minmapframeposX = SubWindowsX(176.f), minmapframeposY = 299.f;
...
void SEASON3B::CNewUICursedTempleSystem::SetButtonInfo()
{
	...
	m_Button[CURSEDTEMPLERESULT_ALPH].ChangeButtonInfo(SubWindowsX(127), 238, 38, 24 );
...
bool SEASON3B::CNewUICursedTempleSystem::UpdateMouseEvent()
{
	...
	if(CheckMouseIn(SubWindowsX(128), 232.f-53.f, 128, 255))
	{
		return false;
	}
...
void SEASON3B::CNewUICursedTempleSystem::RenderSkill()
{
	...
	x = SubWindowsX(100.f); y = 258.f-55.f; Width = 18; Height = 24;
	...
	x = SubWindowsX(45.f); y = 258.f-55.f; Width = 18; Height = 24;
    if (  CheckMouseIn( x, y, Width, Height ) )
    {
		TextNum = 0;
		ZeroMemory( TextListColor, 20 * sizeof ( int));
	...
	x = SubWindowsX(23.f); y = 258.f-55.f; Width = 18; Height = 24;
    if (  CheckMouseIn( x, y, Width, Height ) )
    {
		TextNum = 0;
		ZeroMemory( TextListColor, 20 * sizeof ( int));
...
void SEASON3B::CNewUICursedTempleSystem::RenderGameTime()
{
	...
	x = SubWindowsX(134.f); y = 393.f; Width = 134.f; Height= 37.f;
    RenderBitmap ( IMAGE_CURSEDTEMPLESYSTEM_GAMETIME, x, y, Width, Height, 0.f, 0.f, Width/256.f, Height/64.f );

	x = SubWindowsX(65.5f); y = 407.5f; Width = 3.f; Height= 9.0f;
...
void SEASON3B::CNewUICursedTempleSystem::RenderMiniMap()
{
	...
	// ¾ËÆÄ °ª
	RenderNumber2D(SubWindowsX(108.f), 246.f, static_cast<int>(m_Alph * 100), 8, 8);
	// Á¡¼ö
	RenderNumber2D(SubWindowsX(57.f), 246.f, m_AlliedPoint, 8, 8);
	RenderNumber2D(SubWindowsX(13.f), 246.f, m_IllusionPoint, 8, 8);
