...
void CUIPhotoViewer::RenderPhotoCharacter()
{
	...
	BeginModelPreviewViewport((int)(m_iPos_x * g_fScreenRate_x), (int)(m_iPos_y * g_fScreenRate_y), (int)(m_iWidth * g_fScreenRate_x), (int)(141 * g_fScreenRate_y), 1.f, 2000, 20000, true);
	
	platform::GetRenderBackend().RotateModelView(-90.0f, 1.f, 0.f, 0.f);
	platform::GetRenderBackend().RotateModelView(-90.0f, 0.f, 0.f, 1.f);
	platform::GetRenderBackend().TranslateModelView(-10000.0f, 0.0f, -75.f);

	if(c->Helper.Type == MODEL_HELPER+4)
		platform::GetRenderBackend().TranslateModelView(-o->Position[0], -o->Position[1], -o->Position[2]-50.0f);
	else
		platform::GetRenderBackend().TranslateModelView(-o->Position[0], -o->Position[1], -o->Position[2]);
	...
	platform::GetRenderBackend().SetAlphaFunction(GL_GREATER, 0.25f);
