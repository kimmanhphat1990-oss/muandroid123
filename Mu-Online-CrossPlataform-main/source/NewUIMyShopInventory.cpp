...
bool SEASON3B::CNewUIMyShopInventory::Create(CNewUIManager* pNewUIMng, int x, int y)
{
	...
	m_BtnActive.ChangeButtonImgState(true, 931327, true, false, false);
	m_BtnActive.ChangeButtonInfo(m_Pos.x + 20, m_Pos.y + 391, 55, 29);

	m_BtnExit.ChangeButtonImgState(true, 931325, true, false, false);
	m_BtnExit.ChangeButtonInfo(m_Pos.x + 115, m_Pos.y + 391, 55, 29);
...
const POINT& SEASON3B::CNewUIMyShopInventory::GetPos() const
{
	return m_Pos;
}
...
{
	if (m_BtnActive.UpdateMouseEvent() == true)
	{
...
{
	RenderImage(IMAGE_MYSHOPINVENTORY_BACK, m_Pos.x, m_Pos.y, 190.f, 429.f);
	RenderImage(IMAGE_MYSHOPINVENTORY_TOP, m_Pos.x, m_Pos.y, 190.f, 64.f);
	RenderImage(IMAGE_MYSHOPINVENTORY_LEFT, m_Pos.x, m_Pos.y + 64, 21.f, 320.f);
	RenderImage(IMAGE_MYSHOPINVENTORY_RIGHT, m_Pos.x + 190 - 21, m_Pos.y + 64, 21.f, 320.f);
	RenderImage(IMAGE_MYSHOPINVENTORY_BOTTOM, m_Pos.x, m_Pos.y + 429 - 45, 190.f, 45.f);
	RenderImage(IMAGE_MYSHOPINVENTORY_EDIT, m_Pos.x + 42, m_Pos.y + 49, 169.f, 26.f);
