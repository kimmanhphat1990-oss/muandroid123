...
void SEASON3B::CNewUICursedTempleResult::RenderResultPanel()
{
	...
	if( m_WinState == 1 )
	{
		RenderImage(IMAGE_CURSEDTEMPLERESULT_SUCCESS, setPosCenterX(351.f), m_Pos.y-110, 351.f, 115.f);
	}
	else
	{
		RenderImage(IMAGE_CURSEDTEMPLERESULT_FAILURE, setPosCenterX(351.f), m_Pos.y-110, 351.f, 115.f);
	}
