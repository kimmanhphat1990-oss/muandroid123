...
void SEASON3B::CNewUICharacterInfoWindow::SetButtonInfo()
{
	...
	m_BtnStat[STAT_STRENGTH].ChangeButtonInfo(m_Pos.x + 120, m_Pos.y + HEIGHT_STRENGTH + 2, 24, 24);

	m_BtnStat[STAT_DEXTERITY].ChangeButtonImgState(true, IMAGE_CHAINFO_BTN_STAT, false);
	m_BtnStat[STAT_DEXTERITY].ChangeButtonInfo(m_Pos.x + 120, m_Pos.y + HEIGHT_DEXTERITY + 2, 24, 24);

	m_BtnStat[STAT_VITALITY].ChangeButtonImgState(true, IMAGE_CHAINFO_BTN_STAT, false);
	m_BtnStat[STAT_VITALITY].ChangeButtonInfo(m_Pos.x + 120, m_Pos.y + HEIGHT_VITALITY + 2, 24, 24);

	m_BtnStat[STAT_ENERGY].ChangeButtonImgState(true, IMAGE_CHAINFO_BTN_STAT, false);
	m_BtnStat[STAT_ENERGY].ChangeButtonInfo(m_Pos.x + 120, m_Pos.y + HEIGHT_ENERGY + 2, 24, 24);

	m_BtnStat[STAT_CHARISMA].ChangeButtonImgState(true, IMAGE_CHAINFO_BTN_STAT, false);
	m_BtnStat[STAT_CHARISMA].ChangeButtonInfo(m_Pos.x + 120, m_Pos.y + HEIGHT_CHARISMA + 2, 24, 24);
...
void SEASON3B::CNewUICharacterInfoWindow::RenderFrame()
{
	...
	if (CharacterAttribute->LevelUpPoint > 0)
	{
		GWidescreen.RenderImages(931303, m_Pos.x + 100.f, m_Pos.y + 53.f, 71.f, 18.f, 0.0, 0.0, 160.f, 40.f);
	}

	GWidescreen.RenderImages(931304, m_Pos.x + 11.f, m_Pos.y + 53.f, 71.f, 18.f, 0.0, 0.0, 160.f, 40.f);

	GWidescreen.RenderImages(931304, m_Pos.x + 11.f, m_Pos.y + HEIGHT_STRENGTH, 71.f, 18.f, 0.0, 0.0, 160.f, 40.f);
	GWidescreen.RenderImages(931304, m_Pos.x + 11.f, m_Pos.y + HEIGHT_DEXTERITY, 71.f, 18.f, 0.0, 0.0, 160.f, 40.f);
	GWidescreen.RenderImages(931304, m_Pos.x + 11.f, m_Pos.y + HEIGHT_VITALITY, 71.f, 18.f, 0.0, 0.0, 160.f, 40.f);
	GWidescreen.RenderImages(931304, m_Pos.x + 11.f, m_Pos.y + HEIGHT_ENERGY, 71.f, 18.f, 0.0, 0.0, 160.f, 40.f);

	if (gCharacterManager.GetBaseClass(Hero->Class) == CLASS_DARK_LORD)
	{
		GWidescreen.RenderImages(931304, m_Pos.x + 11.f, m_Pos.y + HEIGHT_CHARISMA, 71.f, 18.f, 0.0, 0.0, 160.f, 40.f);
	}	glColor4f(0.0f, 0.0f, 0.0f, 0.5f);
	
	int iH = (FontHeight / g_fScreenRate_y);

	//-- tableta
	RenderColor(m_Pos.x + 15.f, m_Pos.y + 75.f, 150.f, iH, 0, 0.0);
	RenderColor(m_Pos.x + 15.f, m_Pos.y + 88.f, 150.f, iH, 0, 0.0);
	RenderColor(m_Pos.x + 15.f, m_Pos.y + 101.f, 150.f, iH, 0, 0.0);
	//-- fuerza
	RenderColor(m_Pos.x + 15.f, m_Pos.y + 144.f, 129.f, iH, 0, 0.0);
	RenderColor(m_Pos.x + 15.f, m_Pos.y + 158.f, 129.f, iH, 0, 0.0);
	//-- agilidad
	RenderColor(m_Pos.x + 15.f, m_Pos.y + 199.f, 129.f, iH, 0, 0.0);
	RenderColor(m_Pos.x + 15.f, m_Pos.y + 212.f, 129.f, iH, 0, 0.0);
	RenderColor(m_Pos.x + 15.f, m_Pos.y + 225.f, 129.f, iH, 0, 0.0);
	//-- vitalidad
	RenderColor(m_Pos.x + 15.f, m_Pos.y + 264.f, 129.f, iH, 0, 0.0);
	//-- energi
	RenderColor(m_Pos.x + 15.f, m_Pos.y + 319.f, 129.f, iH, 0, 0.0);
	RenderColor(m_Pos.x + 15.f, m_Pos.y + 332.f, 129.f, iH, 0, 0.0);
	//--
	EndRenderColor();
	...
	if (CharacterAttribute->LevelUpPoint > 0)
	{
		GWidescreen.RenderButtons(931305, m_Pos.x + 120.f, m_Pos.y + HEIGHT_STRENGTH - 2.f, 24.f, 24.f);
		GWidescreen.RenderButtons(931305, m_Pos.x + 120.f, m_Pos.y + HEIGHT_DEXTERITY - 2.f, 24.f, 24.f);
		GWidescreen.RenderButtons(931305, m_Pos.x + 120.f, m_Pos.y + HEIGHT_VITALITY - 2.f, 24.f, 24.f);
		GWidescreen.RenderButtons(931305, m_Pos.x + 120.f, m_Pos.y + HEIGHT_ENERGY - 2.f, 24.f, 24.f);

		if (gCharacterManager.GetBaseClass(Hero->Class) == CLASS_DARK_LORD)
		{
			GWidescreen.RenderButtons(931305, m_Pos.x + 120.f, m_Pos.y + HEIGHT_CHARISMA - 2.f, 24.f, 24.f);
		}
	}
...
void SEASON3B::CNewUICharacterInfoWindow::RenderAttribute()
{
    ...
    {
		g_pRenderText->SetTextColor(218, 189, 160, 255);
    }
	...
	g_pRenderText->RenderText(m_Pos.x + 22, m_Pos.y + HEIGHT_STRENGTH + 6, GlobalText[166], 74, 0, RT3_SORT_LEFT);
	g_pRenderText->RenderText(m_Pos.x + 18, m_Pos.y + HEIGHT_STRENGTH + 6, strStrength, 60, 0, RT3_SORT_RIGHT);
...
//		}
	...
	g_pRenderText->RenderText(m_Pos.x + 22, m_Pos.y + HEIGHT_DEXTERITY + 6, GlobalText[1702], 74, 0, RT3_SORT_LEFT);
	g_pRenderText->RenderText(m_Pos.x + 18, m_Pos.y + HEIGHT_DEXTERITY + 6, strDexterity, 60, 0, RT3_SORT_RIGHT);
	...
	g_pRenderText->SetBgColor(0);
	g_pRenderText->RenderText(m_Pos.x + 22, m_Pos.y + HEIGHT_VITALITY + 6, GlobalText[169], 74, 0, RT3_SORT_LEFT);
	g_pRenderText->RenderText(m_Pos.x + 18, m_Pos.y + HEIGHT_VITALITY + 6, strVitality, 60, 0, RT3_SORT_RIGHT);
	...
	g_pRenderText->SetBgColor(0);
	g_pRenderText->RenderText(m_Pos.x + 22, m_Pos.y + HEIGHT_ENERGY + 6, GlobalText[168], 74, 0, RT3_SORT_LEFT);
	g_pRenderText->RenderText(m_Pos.x + 18, m_Pos.y + HEIGHT_ENERGY + 6, strEnergy, 60, 0, RT3_SORT_RIGHT);
	...
	if(iBaseClass == CLASS_DARK_LORD)
	{
		...
		g_pRenderText->RenderText(m_Pos.x + 22, m_Pos.y + HEIGHT_CHARISMA + 6, GlobalText[1900], 74, 0, RT3_SORT_LEFT);
		g_pRenderText->RenderText(m_Pos.x + 18, m_Pos.y + HEIGHT_CHARISMA + 6, strCharisma, 60, 0, RT3_SORT_RIGHT);
	}
}
...
void SEASON3B::CNewUICharacterInfoWindow::LoadImages()
{
	...
	//
	LoadBitmap("Custom\\NewInterface\\points_v2.jpg", 931303, GL_LINEAR, GL_CLAMP, 1, 0);
	LoadBitmap("Custom\\NewInterface\\stats_v2.jpg", 931304, GL_LINEAR, GL_CLAMP, 1, 0);
	LoadBitmap("Custom\\NewInterface\\btn_plus_v2.jpg", 931305, GL_LINEAR, GL_CLAMP, 1, 0);
	LoadBitmap("Custom\\NewInterface\\btn_menu_v2.jpg", 931324, GL_LINEAR, GL_CLAMP, 1, 0);
	LoadBitmap("Custom\\NewInterface\\none.tga", 931323, GL_LINEAR, GL_CLAMP, 1, 0);
	LoadBitmap("Custom\\NewInterface\\btn_close_2_v2.jpg", 931325, GL_LINEAR, GL_CLAMP, 1, 0);
	LoadBitmap("Custom\\NewInterface\\btn_cancel_v2.jpg", 931326, GL_LINEAR, GL_CLAMP, 1, 0);
	LoadBitmap("Custom\\NewInterface\\btn_confirm_v2.jpg", 931327, GL_LINEAR, GL_CLAMP, 1, 0);
	LoadBitmap("Custom\\btn_register.jpg", 941100, GL_LINEAR, GL_CLAMP, 1, 0);
	LoadBitmap("Custom\\NewInterface\\btn_large_2_v2.jpg", 941101, GL_LINEAR, GL_CLAMP, 1, 0);
	LoadBitmap("Custom\\NewInterface\\btn_medium_v2.jpg", 941102, GL_LINEAR, GL_CLAMP, 1, 0);
}
...
void SEASON3B::CNewUICharacterInfoWindow::ResetEquipmentLevel()
{
	...
	//// - Visual
	//Hero->Weapon[0].Level = (pItem[NEW_EQUIPMENT_WEAPON_RIGHT].Level >> 3) & 15;
	//Hero->Weapon[1].Level = (pItem[NEW_EQUIPMENT_WEAPON_LEFT].Level >> 3) & 15;
	//Hero->BodyPart[BODYPART_HELM].Level = (pItem[NEW_EQUIPMENT_HELM].Level >> 3) & 15;
	//Hero->BodyPart[BODYPART_ARMOR].Level = (pItem[NEW_EQUIPMENT_ARMOR].Level >> 3) & 15;
	//Hero->BodyPart[BODYPART_PANTS].Level = (pItem[NEW_EQUIPMENT_PANTS].Level >> 3) & 15;
	//Hero->BodyPart[BODYPART_GLOVES].Level = (pItem[NEW_EQUIPMENT_GLOVES].Level >> 3) & 15;
	//Hero->BodyPart[BODYPART_BOOTS].Level = (pItem[NEW_EQUIPMENT_BOOTS].Level >> 3) & 15;
