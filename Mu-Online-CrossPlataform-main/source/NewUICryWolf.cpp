...
bool SEASON3B::CNewUICryWolf::Render()
{
	...
	float Main[] = { setPosRight(518.f), 278.f, 122.f, 119.f, 120.f / 128.f,118.f / 128.f };
	float Number[5][6] =   {{setPosRight(565.f),280.f,13.f,13.f,12.f/16.f,12.f/16.f},
							{setPosRight(582.f),282.f,13.f,13.f,12.f/16.f,12.f/16.f},
							{setPosRight(598.f),286.f,13.f,13.f,12.f/16.f,12.f/16.f},
							{setPosRight(613.f),294.f,13.f,13.f,12.f/16.f,12.f/16.f},
							{setPosRight(625.f),306.f,13.f,13.f,12.f/16.f,12.f/16.f}};
	float Dark_Elf_Icon[] = { setPosRight(623.f),358.f,15.f,15.f,14.f / 16.f,14.f / 16.f };
	float Val_Icon[] = { setPosRight(623.f),379.f,15.f,15.f,14.f/16.f,14.f/16.f};
	int TotDelay = 400;
	...
	if(Suc_Or_Fail >= 0)
	{
		...
		if((Delay*15) > setPosMidRight(479))
		{
			g_pCryWolfInterface->Render(setPosMidRight(150), 50, 329, 94, 0.f, 0.f, 328.f / 512.f, 93.f / 128.f, Add_Num, false, false, A_Value);
		}
		else if(Suc_Or_Fail == 0)
		{
			g_pCryWolfInterface->Render(setPosMidRight(150) + (Delay * 15), 50, 329, 94, 0.f, 0.f, 328.f / 512.f, 93.f / 128.f, Add_Num, false, false, A_Value);
		...
		g_pCryWolfInterface->Render(setPosMidRight(230), 150, 196, 141, 0.f, 0.f, 195.f / 256.f, 140.f / 256.f, 26);
		g_pCryWolfInterface->Render(setPosMidRight(250) + Delay_Add_inter, 188, 110, 28, 0.f, 0.f, 110.f / 128.f, 27.f / 32.f, 27);

		if(Delay_Add_inter == 0)
		{
			int Exp_val[9] = {0,0,0,0,0,0,0,0,0},Exp_Dummy = 0,Val = 0;

			g_pCryWolfInterface->Render(setPosMidRight(370), 188, 29, 28, 0.f, 0.f, 29.f / 32.f, 27.f / 32.f, 28 + Rank);
			...
			g_pCryWolfInterface->Render(setPosMidRight(200) + Move_X, 235, 60, 19, 0.f, 0.f, 60.f / 64.f, 19.f / 32.f, 43);
			g_pCryWolfInterface->Render(setPosMidRight(380) + Move_X, 235, 15, 19, 0.f, 0.f, 15.f / 16.f, 19.f / 32.f, 33 + Exp_val[8]);
			g_pCryWolfInterface->Render(setPosMidRight(365) + Move_X, 235, 15, 19, 0.f, 0.f, 15.f / 16.f, 19.f / 32.f, 33 + Exp_val[7]);
			g_pCryWolfInterface->Render(setPosMidRight(350) + Move_X, 235, 15, 19, 0.f, 0.f, 15.f / 16.f, 19.f / 32.f, 33 + Exp_val[6]);
			g_pCryWolfInterface->Render(setPosMidRight(335) + Move_X, 235, 15, 19, 0.f, 0.f, 15.f / 16.f, 19.f / 32.f, 33 + Exp_val[5]);
			g_pCryWolfInterface->Render(setPosMidRight(320) + Move_X, 235, 15, 19, 0.f, 0.f, 15.f / 16.f, 19.f / 32.f, 33 + Exp_val[4]);
			g_pCryWolfInterface->Render(setPosMidRight(305) + Move_X, 235, 15, 19, 0.f, 0.f, 15.f / 16.f, 19.f / 32.f, 33 + Exp_val[3]);
			g_pCryWolfInterface->Render(setPosMidRight(290) + Move_X, 235, 15, 19, 0.f, 0.f, 15.f / 16.f, 19.f / 32.f, 33 + Exp_val[2]);
			g_pCryWolfInterface->Render(setPosMidRight(275) + Move_X, 235, 15, 19, 0.f, 0.f, 15.f / 16.f, 19.f / 32.f, 33 + Exp_val[1]);
			g_pCryWolfInterface->Render(setPosMidRight(260) + Move_X, 235, 15, 19, 0.f, 0.f, 15.f / 16.f, 19.f / 32.f, 33 + Exp_val[0]);
		}	
	}
	...
	g_pCryWolfInterface->Render(setPosRight(538), 392, 104, 37, 0.f,0.f,104.f/128.f, 36.f/64.f,12);
    ...
    g_pRenderText->RenderText(setPosRight(582), 359, Text, 0 ,0, RT3_WRITE_CENTER);
	...
	if(View_Bal == true) 
	{
		...
		else
		{
			...
			g_pRenderText->RenderText(setPosRight(600), 380, Text, 0 ,0, RT3_WRITE_CENTER);

			float Hp = ((67.f / 100.f) * (float)Val_Hp);
			float nx = ((68.f / 100.f) * (float)Val_Hp);

			g_pCryWolfInterface->Render(setPosRight(548), 388, nx, 8, 0.f,0.f,Hp/128.f, 8.f/8.f,1);
		}
	}
	if(View_Bal == false)
	{
	...
	if(m_bTimeStart == true && m_CrywolfState == CRYWOLF_STATE_START)
	{
		...
		if( m_iMinute < 10 )
		{
			RenderNumber2D(setPosRight(510 + 60), 384 + 18, 0, 14, 14);
		}
		RenderNumber2D(setPosRight(510 + 70), 384 + 18, m_iMinute, 14, 14);
		if( m_iSecond/1000 < 10 )
		{
			RenderNumber2D(setPosRight(520 + 77), 384 + 18, 0, 14, 14);
		}
		RenderNumber2D(setPosRight(520 + 87), 384 + 18, m_iSecond / 1000, 14, 14);
	...
	{
		RenderNumber2D(setPosRight(510 + 60), 384 + 18, 0, 14, 14);
		RenderNumber2D(setPosRight(510 + 70), 384 + 18, 0, 14, 14);
		RenderNumber2D(setPosRight(520 + 77), 384 + 18, 0, 14, 14);
		RenderNumber2D(setPosRight(520 + 87), 384 + 18, 0, 14, 14);
	}

	int HpS = 100 - m_StatueHP;
	float Hp = ((88.f / 100.f) * (float)HpS);
	float nx = ((89.f / 100.f) * (float)HpS);
	RenderImage(IMAGE_MVP_INTERFACE + 9, setPosRight(548) + nx, 323, 89.f - nx, 30, Hp / 128.f, 0.f, ((((88.f / 100.f)* (float)(100.f - HpS))) / 128.f), 29.f / 32.f);
	...
	int Yes = setPosMidRight(250);
	int No = setPosMidRight(330);
	...
	if(Message_Box == 1)
	{
		g_pCryWolfInterface->Render(setPosMidRight(212), 206, 209, 80, 0.f, 0.f, 206.f / 256.f, 77.f / 128.f, 22);
		...
		if(Box_String[0][0] != NULL)
		{
			...
			if(Box_String[1][0] != NULL)
				Y_loc = 227;
			g_pRenderText->RenderText(setPosMidRight(317), Y_loc, Box_String[0], 0, 0, RT3_WRITE_CENTER);
		}
		if(Box_String[1][0] != NULL)
		{
			g_pRenderText->RenderText(setPosMidRight(317), 238, Box_String[1], 0, 0, RT3_WRITE_CENTER);
		}
	...
	else if(Message_Box == 2)
	{
		...
		if(MouseX > setPosMidRight(290) && MouseX < setPosMidRight(344) && MouseY > 250 && MouseY < 250+30)
		{
			if(Button_Down == 3)
			{
				g_pCryWolfInterface->Render(setPosMidRight(290), 250, 54, 30, 0.f, 0.f, 53.f / 64.f, 30.f / 32.f, 18);
			...
			{
				g_pCryWolfInterface->Render(setPosMidRight(290), 250, 54, 30, 0.f, 0.f, 53.f / 64.f, 30.f / 32.f, 17);
			}
		}
		else
		{
			g_pCryWolfInterface->Render(setPosMidRight(290), 250, 54, 30, 0.f, 0.f, 53.f / 64.f, 30.f / 32.f, 16);
		}
