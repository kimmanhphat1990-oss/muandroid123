...
namespace
{
	inline void SetTerrainVertex3D(platform::Vertex3D* vertex, const vec3_t position, const vec2_t tex_coord, float r, float g, float b, float a)
	{
		vertex->x = position[0];
		vertex->y = position[1];
		vertex->z = position[2];
		vertex->u = tex_coord[0];
...
void RenderFace(int Texture,int mx,int my)
{
	...
	SetTerrainVertex3D(&quad[0], TerrainVertex[0], TerrainTextureCoord[0], PrimaryTerrainLight[TerrainIndex1][0], PrimaryTerrainLight[TerrainIndex1][1], PrimaryTerrainLight[TerrainIndex1][2], 1.f);
	SetTerrainVertex3D(&quad[1], TerrainVertex[1], TerrainTextureCoord[1], PrimaryTerrainLight[TerrainIndex2][0], PrimaryTerrainLight[TerrainIndex2][1], PrimaryTerrainLight[TerrainIndex2][2], 1.f);
	SetTerrainVertex3D(&quad[2], TerrainVertex[2], TerrainTextureCoord[2], PrimaryTerrainLight[TerrainIndex3][0], PrimaryTerrainLight[TerrainIndex3][1], PrimaryTerrainLight[TerrainIndex3][2], 1.f);
	SetTerrainVertex3D(&quad[3], TerrainVertex[3], TerrainTextureCoord[3], PrimaryTerrainLight[TerrainIndex4][0], PrimaryTerrainLight[TerrainIndex4][1], PrimaryTerrainLight[TerrainIndex4][2], 1.f);
...
void RenderFaceAlpha(int Texture,int mx,int my)
{
	...
	platform::Vertex3D quad[4];
	SetTerrainVertex3D(&quad[0], TerrainVertex[0], TerrainTextureCoord[0], PrimaryTerrainLight[TerrainIndex1][0], PrimaryTerrainLight[TerrainIndex1][1], PrimaryTerrainLight[TerrainIndex1][2], TerrainMappingAlpha[TerrainIndex1]);
	SetTerrainVertex3D(&quad[1], TerrainVertex[1], TerrainTextureCoord[1], PrimaryTerrainLight[TerrainIndex2][0], PrimaryTerrainLight[TerrainIndex2][1], PrimaryTerrainLight[TerrainIndex2][2], TerrainMappingAlpha[TerrainIndex2]);
	SetTerrainVertex3D(&quad[2], TerrainVertex[2], TerrainTextureCoord[2], PrimaryTerrainLight[TerrainIndex3][0], PrimaryTerrainLight[TerrainIndex3][1], PrimaryTerrainLight[TerrainIndex3][2], TerrainMappingAlpha[TerrainIndex3]);
	SetTerrainVertex3D(&quad[3], TerrainVertex[3], TerrainTextureCoord[3], PrimaryTerrainLight[TerrainIndex4][0], PrimaryTerrainLight[TerrainIndex4][1], PrimaryTerrainLight[TerrainIndex4][2], TerrainMappingAlpha[TerrainIndex4]);
	platform::GetRenderBackend().DrawQuad3D(quad, true, true);
}
...
void RenderFaceBlend(int Texture,int mx,int my)
{
	...
	platform::Vertex3D quad[4];
	SetTerrainVertex3D(&quad[0], TerrainVertex[0], TerrainTextureCoord[0], TerrainMappingAlpha[TerrainIndex1], TerrainMappingAlpha[TerrainIndex1], TerrainMappingAlpha[TerrainIndex1], 1.f);
	SetTerrainVertex3D(&quad[1], TerrainVertex[1], TerrainTextureCoord[1], TerrainMappingAlpha[TerrainIndex2], TerrainMappingAlpha[TerrainIndex2], TerrainMappingAlpha[TerrainIndex2], 1.f);
	SetTerrainVertex3D(&quad[2], TerrainVertex[2], TerrainTextureCoord[2], TerrainMappingAlpha[TerrainIndex3], TerrainMappingAlpha[TerrainIndex3], TerrainMappingAlpha[TerrainIndex3], 1.f);
	SetTerrainVertex3D(&quad[3], TerrainVertex[3], TerrainTextureCoord[3], TerrainMappingAlpha[TerrainIndex4], TerrainMappingAlpha[TerrainIndex4], TerrainMappingAlpha[TerrainIndex4], 1.f);
	platform::GetRenderBackend().DrawQuad3D(quad, true, true);
}
...
bool RenderTerrainTile(float xf,float yf,int xi,int yi,float lodf,int lodi,bool Flag)
{
	...
	if(!Flag)
	{
...
#endif // CSK_DEBUG_MAP_PATHFINDING
		{
			if ( 2 <= path->GetClosedStatus( TerrainIndex1))
			{
				EnableAlphaTest();
				DisableTexture();
				const float alpha = (4 <= path->GetClosedStatus( TerrainIndex1)) ? 0.5f : 0.3f;
				const float red = (4 <= path->GetClosedStatus( TerrainIndex1)) ? 0.3f : 1.0f;
				const float green = (4 <= path->GetClosedStatus( TerrainIndex1)) ? 0.3f : 1.0f;
				...
				for(int i=0;i<4;i++)
				{
					SetTerrainVertex3D(&quad[i], TerrainVertex[i], TerrainTextureCoord[i], red, green, blue, alpha);
				}
				platform::GetRenderBackend().DrawQuad3D(quad, false, true);
				DisableAlphaBlend();
			}
		}
	...
	else
	{
		...
		{
			DisableTexture();
			platform::Vertex3D line_vertices[6];
			SetTerrainVertex3D(&line_vertices[0], TerrainVertex[0], TerrainTextureCoord[0], 0.5f, 0.5f, 0.5f, 1.f);
			SetTerrainVertex3D(&line_vertices[1], TerrainVertex[1], TerrainTextureCoord[1], 0.5f, 0.5f, 0.5f, 1.f);
			SetTerrainVertex3D(&line_vertices[2], TerrainVertex[1], TerrainTextureCoord[1], 0.5f, 0.5f, 0.5f, 1.f);
			SetTerrainVertex3D(&line_vertices[3], TerrainVertex[2], TerrainTextureCoord[2], 0.5f, 0.5f, 0.5f, 1.f);
			SetTerrainVertex3D(&line_vertices[4], TerrainVertex[2], TerrainTextureCoord[2], 0.5f, 0.5f, 0.5f, 1.f);
			SetTerrainVertex3D(&line_vertices[5], TerrainVertex[3], TerrainTextureCoord[3], 0.5f, 0.5f, 0.5f, 1.f);
			platform::GetRenderBackend().DrawLineList3D(line_vertices, 6, true);
			DisableAlphaBlend();
		}
#endif// _DEBUG
           ...
           ) )
		{
			...
			for(int i=0;i<4;i++)
			{
				SetTerrainVertex3D(&quad[i], TerrainVertex[i], TerrainTextureCoord[i], 1.f, 0.5f, 0.5f, 0.3f);
			}
			platform::GetRenderBackend().DrawQuad3D(quad, false, true);
...
void RenderTerrainBitmapTile(float xf,float yf,float lodf,int lodi,vec3_t c[4],bool LightEnable,float Alpha,float Height=0.f)
{
	...
	for(int i=0;i<4;i++)
	{
		if(LightEnable)
		{
			SetTerrainVertex3D(&quad[i], TerrainVertex[i], c[i], Light[i][0], Light[i][1], Light[i][2], Alpha);
		}
		else
		{
			SetTerrainVertex3D(&quad[i], TerrainVertex[i], c[i], 1.f, 1.f, 1.f, Alpha);
		}
	}
	platform::GetRenderBackend().DrawQuad3D(quad, true, LightEnable);
}
