...
namespace SEASON3B
{
	...
	protected:
		...
		/* Interface classes */
	private:
		CChaosGenesis*					m_pChaosGenesis;
		CStackInterface*				m_pStackInterface;
...
#ifdef NEW_MUHELPER_ON
		CGFxMacroMain* m_GFxMacroMain;
		CGFxMacroGaugeBar* m_GFxMacroGaugeBar;
		CGFxMacroSubMain* m_GFxMacroSubMain;
#endif
	...
	public:
		...
		CStackInterface* GetUI_StackInterface() const;
...
#ifdef NEW_MUHELPER_ON
		CGFxMacroMain* GetGFxMacroMain() const;
		CGFxMacroGaugeBar* GetGFxMacroGaugeBar() const;
		CGFxMacroSubMain* GetGFxMacroSubMain() const;
#endif
...
#define g_pChaosGenesis SEASON3B::CNewUISystem::GetInstance()->GetUI_ChaosGenesis()
#define g_pStackInterface SEASON3B::CNewUISystem::GetInstance()->GetUI_StackInterface()
...
#ifdef NEW_MUHELPER_ON
#define GFxMacroMain SEASON3B::CNewUISystem::GetInstance()->GetGFxMacroMain()
#define GFxMacroSubMain SEASON3B::CNewUISystem::GetInstance()->GetGFxMacroSubMain()
#define GFxMacroGaugeBar SEASON3B::CNewUISystem::GetInstance()->GetGFxMacroGaugeBar()
#endif
