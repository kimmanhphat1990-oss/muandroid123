...
BOOL CGaugeBar::CursorInObject()
{
	...
	if (m_psizeResponse)
	{
		RECT rc = 
		{
			static_cast<LONG>(m_nXPos * fScaleX),
			static_cast<LONG>(m_nYPos * fScaleY),
			static_cast<LONG>((m_nXPos + m_psizeResponse->cx) * fScaleX),
			static_cast<LONG>((m_nYPos + m_psizeResponse->cy) * fScaleY)
		};
	...
	RECT rc = 
	{
		static_cast<LONG>(m_rcGauge.left * fScaleX),
		static_cast<LONG>(m_rcGauge.top * fScaleY),
		static_cast<LONG>(m_rcGauge.right * fScaleX),
		static_cast<LONG>(m_rcGauge.bottom * fScaleY)
	};
